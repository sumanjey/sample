...
<div style="text-align: center">
    ...
    <h4 style="text-align: left">User : {{ $user }}</h4>
...
<table style="width: 100%; border: 0.5px solid gray; border-collapse: collapse">
    <tr>
        ...
        <th style="padding:10px 10px 20px 10px; border: 0.5px solid gray">Post Count</th>
    ...
    @foreach($data as $data1)
        <tr>
            ...
            <td style="padding:10px 10px 20px 10px; border: 0.5px solid gray">{{ $data1['post'] }}</td>
